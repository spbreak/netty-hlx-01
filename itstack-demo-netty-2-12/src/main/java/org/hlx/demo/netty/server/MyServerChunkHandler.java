...
public class MyServerChunkHandler extends ChannelOutboundHandlerAdapter {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        ...
        ChunkedStream stream = new ChunkedStream(in, 20);
        //管道消息传输承诺
        ...
        progressivePromise.addListener(new ChannelProgressiveFutureListener() {
            ...
            public void operationProgressed(ChannelProgressiveFuture future, long progress, long total) throws Exception {
                System.out.println("operationProgressed future : " + future);
                System.out.println("operationProgressed progress : " + progress);
                System.out.println("operationProgressed total : " + total);
